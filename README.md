...
| [ClawBench: Can AI Agents Complete Everyday Online Tasks?](https://arxiv.org/abs/2604.08523) | Preprint 2026 | Evaluates browser agents on 153 write-heavy tasks across 144 live websites, with final-request interception and synchronized video, screenshot, network, action, and message traces for auditable scoring and failure analysis. | [[Code]](https://github.com/reacher-z/ClawBench) [[Project]](https://claw-bench.com/) |
