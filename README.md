...
| [ClawBench: Can AI Agents Complete Everyday Online Tasks?](https://arxiv.org/abs/2604.08523) | Preprint 2026 | A live-web benchmark of 153 everyday tasks across 144 websites with isolated browser sessions and auditable replay, action, HTTP, screenshot, and agent-message traces. | [[Code]](https://github.com/reacher-z/ClawBench) · [[Project]](https://claw-bench.com/) |
